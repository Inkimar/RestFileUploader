...
public class FileUploadService {
	...
	private final String UPLOAD_FOLDER = "/tmp/uploader/";
	...
	/**
	 * This method is able to store files up to 6GB (note tested files>6GB)
	 *  - curl -v  -F 'file=@dragon.gif' ${HOST}/rest/upload ('file' is necessary, see the method)
	 *  
	...
	public Response uploadFile(@FormDataParam("file") InputStream uploadedInputStream,
		...
		logger.info("Test: Check out this -> " + fileDetail.getSize());
		try {
	...
	@Path("/extra")
	@Consumes(MediaType.MULTIPART_FORM_DATA)
	public Response uploadFileextra(@FormDataParam("file") InputStream uploadedInputStream,
			@FormDataParam("file") FormDataContentDisposition fileDetail) {
